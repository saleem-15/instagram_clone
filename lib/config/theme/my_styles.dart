          ...
          backgroundColor: WidgetStateProperty.resolveWith<Color>(
            (Set<WidgetState> states) {
              if (states.contains(WidgetState.pressed)) {
                return LightThemeColors.buttonColor.withValues(alpha: 0.8);
...
// static
  static RadioThemeData getRadioButtonTheme() => RadioThemeData(
        fillColor: WidgetStateProperty.all<Color>(LightThemeColors.radioColor),
      );
  ...
  static InputDecorationTheme getInputDecorationTheme() => InputDecorationTheme(
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide:
              const BorderSide(color: LightThemeColors.lightGrey, width: 1),
        ),
  ...
  static InputDecoration getInputDecoration() => InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide:
              const BorderSide(color: LightThemeColors.lightGrey, width: 1.5),
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10.r),
          borderSide:
  ...
  static ButtonStyle getAuthButtonStyle() => ButtonStyle(
        ...
        backgroundColor: WidgetStateProperty.resolveWith<Color>(
          (Set<WidgetState> states) {
            if (states.contains(WidgetState.pressed)) {
              return LightThemeColors.authButtonColor.withValues(alpha: 0.8);
            } else if (states.contains(WidgetState.disabled)) {
              return LightThemeColors.authButtonColor.withValues(alpha: .4);
            }
            return LightThemeColors
